package me.n4th4not.dynamicfps.util.event;
...
public class WindowObserver {
    ...
    private void onFocusChanged(long address, boolean focused) {
        ...
        if (this.previousFocusCallback != null) this.previousFocusCallback.invoke(address, focused);
    }
    ...
    private void onMouseChanged(long address, boolean hovered) {
        ...
        if (this.previousMouseCallback != null) this.previousMouseCallback.invoke(address, hovered);
    }
    ...
    private void onIconifyChanged(long address, boolean iconified) {
        ...
        if (this.previousIconifyCallback != null) this.previousIconifyCallback.invoke(address, iconified);
    }
}