...
public class Version
    ...
    public static Version of(String raw) throws VersionParseException {
        ...
        if (!matcher.matches()) throw new VersionParseException(raw);
        ...
        if (matcher.group("patch") != null) patch = Integer.parseInt(matcher.group("patch"));
    ...
    public String toString() {
        ...
        if (this.isPreRelease()) result += "-" + this.preRelease();

        if (this.hasBuildMetadata()) result += "+" + this.buildMetadata();
    ...
    public int compareTo(@NotNull Version other) {
        ...
        else if (this.isPreRelease()) return -1;
        else if (other.isPreRelease()) return +1;
